...
#define GCONFIG_SPORT_BRATE_4800		0x3000
...
#define GCONFIG_FTYPE_BLDR              0
#define GCONFIG_FTYPE_MCPU              1
#define GCONFIG_FTYPE_WCPU              2
...
typedef struct
{
    ...
    U8_T WifiProtectFrame;      /* 0: RTS  1: Self-CTS */
    U8_T Rsvd[3];
...
typedef struct _GCONFIG_UPGRADE_PKT
{
    ...
    U32_T               TftpSrvIp;
    U8_T                Filename[64];
    U8_T                FirmwareType;// 0/1/2 = bootloader/MCPU/WCPU
	U8_T				Rsvd[3];
} GCONFIG_UPGRADE_PKT;
