...
#define		DHCP_INITIAL_STATE			1
#define		DHCP_DISCOVER_STATE			2
#define		DHCP_RCV_OFFER_STATE		3
#define		DHCP_REQUEST_STATE			4
#define		DHCP_RCV_ACK_STATE			5
#define		DHCP_RENEW_STATE			6
#define		DHCP_RENEW_RCV_ACK_STATE	7
